# Awesome GPT Image 2 繁體中文

最後更新於 260424 03:26:42 UTC
...
- [🎮 遊戲與娛樂](#-game--entertainment)
- [📱 UI / UX 與社群媒體](#-uiux--social-media)
- [🎬 影片、動畫與拼貼](#-video-animation--collage)
- [📰 字體排版與海報設計](#-typography--poster-design)
- [📚 資訊圖、教育與文件](#-infographics-education--documents)
- [🎭 角色與一致性](#-character--consistency)
- [🖼️ 圖像編輯與風格轉換](#-image-editing--style-transfer)
- [📊 資源](#-resources)
- [🤝 貢獻](#-contributing)
...
**提示詞:**
```text
山姆・奧特曼、唐納德・川普與伊隆・馬斯克在一家忙碌電影院的櫃檯後方工作。
```
**來源:** [ @flowersslop ](https://x.com/flowersslop/status/2044334054380552438)
...
**提示詞:**
```text
在夏夜晚上 10 點的便利商店門口，生成一張超寫實的城市街頭多人合照。3 到 4 位年輕人在門口短暫聊天，有人拿著飲料、有人坐在戶外塑膠椅上、有人站著看手機。玻璃門窗透出明亮白光，外面有暖黃色街燈與遠處車燈。人物穿著 T 恤、襯衫、短褲、牛仔褲、球鞋等日常服飾，不要網紅感。臉部與姿態必須像真實路人，不可過度精修。環境需包含真實便利商店元素：冷櫃貼紙、促銷海報、垃圾桶、門口地墊、玻璃反射、路邊共享單車、地上的飲料瓶水珠。整張圖應像城市攝影師抓拍到的真實生活切片，重點是自然多人互動、夜間便利商店光線、玻璃反光，以及一般人的氛圍還原。
```
*來源: [卡爾的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*
...
**提示詞:**
```text
生成一張完全 RAW 品質、未經處理、未經編輯、保留完整 iPhone 相機畫質的圖像。場景是美國的一座地鐵站，帶有一瞬間的動態模糊。地鐵正在行駛，前方站著一位老年女性與一位老年男性。
```
**來源:** [ @WolfRiccardo ](https://x.com/WolfRiccardo/status/2041192232623972441)
...
**提示詞:**
```text
在 Apple Park 舉辦 iPhone 20 發表會時，用 iPhone 從遠處觀眾區拍到的業餘照片，提姆・庫克正在台上發表演講。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/apple-park-tim-cook-keynote) | [@patrickassale](https://x.com/patrickassale/status/2044687244368441742)
...
**提示詞:**
```text
一張業餘照片，打開的筆記本平放在桌上，裡面以黑色原子筆寫滿手寫筆記。字跡隨意且略顯凌亂，像個人筆記，有自然瑕疵、劃掉的詞與加底線的標題。從略高角度拍攝，窗邊自然日光、無閃光燈，輕鬆的桌面環境，用 iPhone 拍攝。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/black-pen-handwritten-notes) | [@patrickassale](https://x.com/patrickassale/status/2044569086013718958)
...
**提示詞:**
```text
一大堆米，其中有一粒米上寫著極小的文字「wOw」。
```
**來源:** [ @adonis_singh ](https://x.com/adonis_singh/status/2046673729082560919)
...
[地點] 的 360 等距柱狀圖像。
```
**來源:** [ @LexnLin ](https://x.com/LexnLin/status/2046725722320888313) | [ @LexnLin ](https://x.com/LexnLin/status/2046675069678563385)
...
**來源:** [ @marmaduke091 ](https://x.com/marmaduke091/status/2040338311873515597)
...
**提示詞:**
```text
一個《Hitman》關卡，你人在 OpenAI 總部，任務是在不被抓到的情況下偷走 GPT-6。
```
**來源:** [ @flowersslop ](https://x.com/flowersslop/status/2044734896321532390)
...
**提示詞:**
```text
GTA 6 遊戲內畫面，非常細緻、非常真實。鏡頭是近距離拍攝一台固定的 4K 顯示器。（畫面有一點手持拍攝般的輕微模糊。）環境寬闊明亮，細節逼真。角色正和 / :dog. 一起走在海灘上。
```
**來源:** [ @WolfRiccardo ](https://x.com/WolfRiccardo/status/2041187268711321735)
...
**提示詞:**
```text
生成一張 GTA 6 的遊戲截圖，內容為 [場景描述]。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046109786840711246)
...
**提示詞:**
```text
生成一張包含 100 個完全獨特像素風物件的單張圖像，並為每個物件加上有意義的標籤。
```
...
**提示詞:**
```text
在《薩爾達傳說：王國之淚》中，林克坐在一列由他自己製作的 e531 系列列車裡。
```
**來源:** [ @marmaduke091 ](https://x.com/marmaduke091/status/2040820686751432990)
...
**提示詞:**
```text
一張 GTA San Andreas 的遊戲畫面截圖，內容是一頭獅子正在和一名 NPC 打鬥。
```
...
**來源:** [ @flowersslop ](https://x.com/flowersslop/status/2040693687500341568)
...
**提示詞:**
```text
生成一張 TikTok 直播截圖，畫面中是一位漂亮女性正在直播。
```
...
**提示詞:**
```text
9:16 長寬比，生成一張抖音直播截圖，畫面中是劉亦菲正在直播，手裡拿著牌子，牌子上寫著「今晚直播，歡迎來和亦菲聊天！」。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/liu-yifei-douyin-live-chat) | [@alanblogsooo](https://x.com/alanblogsooo/status/2044784762594918516)
...
**提示詞:**
```text
一張 YouTube 影片截圖，內容是某人穿越到了中世紀。
```
**來源:** [ @flowersslop ](https://x.com/flowersslop/status/2040261168460108213)
...
**提示詞:**
```text
「宋朝人的朋友圈」／「SONG DYNASTY SOCIAL MEDIA FEED」，採用古今穿越幽默融合的介面設計風格。畫面模擬手機社群媒體介面，但內容全部是宋朝場景。頭像是宋代文人肖像，使用者名稱為「Su Dongpo SuShi_Official」，發文內容為「Just arrived in Huangzhou, demoted but feeling okay. Made Dongpo pork myself today, tastes amazing, recipe attached:」。附圖是工筆畫風格的東坡肉特寫。按讚列表為「Huang Tingjian, Qin Guan, Fo Yin etc. 126 people」，留言區為「Wang Anshi: Hehe」「Sima Guang: Still the same taste」。按讚圖示等介面元素改為宋代紋樣，狀態列顯示「Great Song Mobile 5G」與「Third Year of Yuanfeng」，整體配色為手機深色模式搭配雅致宋韻色調，呈現歷史與社群媒體的趣味碰撞。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/song-dynasty-cyber-social-feed) | [@Panda20230902](https://x.com/Panda20230902/status/2045385588065313057)
...
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046585220393324553)
...
**提示詞:**
```text
生成一張高擬真的行動電商 App 首頁截圖，靈感來自 2026 年中國主流電商 App。介面必須完全真實，具備完整的行動 App UI 邏輯與成熟商業設計質感。需要包含狀態列、搜尋區、分類標籤、頂部輪播 Banner、10 圖示功能區、限時秒殺模組、猜你喜歡雙欄商品瀑布流，以及五欄底部 Tab。需要使用原 prompt 中列出的精確中文標籤，例如「杭州」「搜索耳机、咖啡机、运动鞋」「618 预售开启」「猜你喜欢」等，並確保所有中文字清晰可讀、字體真實，整體更像真實 App 截圖而非概念設計圖。
```
*來源: [卡爾的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*
...
**提示詞:**
```text
建立一張高擬真的中文音樂 App 播放器截圖，使用手機直式比例與深色模式，背景來自專輯封面色彩的模糊擴散版本，中央放置大型方形專輯封面。需要包含 18:26 狀態列、返回按鈕、標題、更多操作、01:42 / 04:18 播放進度、播放控制鍵、5 到 7 行歌詞、按讚／留言／下載／加入歌單／分享，以及投放裝置與播放佇列入口。需使用原 prompt 中列出的精確中文標籤：「正在播放」「海边的晚风」「林秋」「夏夜实验室」，並讓整體質感更像量產產品而不是概念稿。
```
*來源: [卡爾的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*
...
**提示詞:**
```text
幫我生成一套 xx 風格的 UI 設計系統，包含網頁、行動端、卡片、控制元件、按鈕等內容。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/custom-style-ui-system) | [@stark_nico99](https://x.com/stark_nico99/status/2045836554451706125)
...
**提示詞:**
```text
生成圖片：T-800 機器人的淘寶商品詳情頁，展示機器人的正面、側面與背面三視圖、商品價格、商品詳情，以及功能與使用情境。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/terminator-taobao-page) | [@rionaifantasy](https://x.com/rionaifantasy/status/2045356799751303194)
...
**提示詞:**
```text
整部《超人》電影的一張拼貼圖，一次輸出成一張圖。
```
**來源:** [ @chetaslua ](https://x.com/chetaslua/status/2044462992176386532)

### “Where is [Your Name]” 人群尋找海報
...
**提示詞:**
```text
生成一張「Where is [Your Name]」風格的人群尋找海報，背景城市可自由選擇。
```
...
**來源:** [ @icreatelife ](https://x.com/icreatelife/status/2046639884421550482)
...
**提示詞:**
```text
創作一篇關於 GPT-Image-2 今天上線的八格漫畫。
```
**來源:** [ @venturetwins ](https://x.com/venturetwins/status/2046620134933250409)
...
## 📰 字體排版與海報設計
用於測試複雜文字排版、資訊密度與高完成度視覺設計的提示詞。

*來源: [卡尔的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*
...
**提示詞:**
```text
生成一張 1980 年代風格的宣傳海報，使用精確標語「热烈庆祝GPT-Image-2全量开放」，並包含 Sam Altman、Dario Amodei、Elon Musk，且為 Dario Amodei 配上一條紅領巾。
```
**來源:** [ @akokoi1 ](https://x.com/akokoi1/status/2046558658096738672)
...
**提示詞:**
```text
設計一張 3:4 直式海報，宣傳新的中式潮流茶飲。採用新中式視覺風格，整體輕奢克制，使用深綠、米白、金色、宣紙紋理、留白、山水元素與現代版式。主體是一杯具吸引力的冷泡茶，含茶葉、柑橘、冰塊與少量金箔。畫面需精確顯示原 prompt 中列出的中文文案，如「山川茶事」「山柚观音」「冷泡系列」「新品上市」等，以及細字「图片仅供参考，请以门店实际售卖为准」，並兼顧促銷層級、數字、價格、小字與中文排版美感。
```
...
**提示詞:**
```text
製作一張主題為「一杯咖啡 如何来到你手里」的中文資訊圖海報，使用高級資訊設計風格，兼顧科普清晰度與商業展示感。需要包含種植、處理、烘焙、研磨、萃取、風味關鍵詞等模組，以及精確小字「适合用于咖啡入门科普与门店展示」，整體應像高級展示板而不是教室投影片。
```
...
請為「XXX」生成一張核心角色關係圖。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/key-character-relationship-map) | [@yihui_indie](https://x.com/yihui_indie/status/2045179926270361890)
...
**提示詞:**
```text
生成一張景德鎮青花瓷的詳細解析圖，並附上詳細的中文知識分析。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/jingdezhen-blue-white-porcelain-diagram) | [@joshesye](https://x.com/joshesye/status/2045764695827562686)
...
**提示詞:**
```text
圍繞 [Subject] 自動生成一張「博物館圖錄風中文拆解資訊圖」。整張圖要把真實主體主視覺、結構拆解、中文標註、材質說明、紋樣寓意、色彩寓意與核心特徵總結融合在一起，並自動判斷最適合的主體、服飾系統、器物結構、時代風格、關鍵部件、材質工藝、配色與版面。整體應偏向國家級博物館展板、歷史服飾圖錄與文化博物館專題資訊圖，所有文字必須為清晰可讀的簡體中文，避免海報感、電商感、動漫感、隨機標註或錯誤結構。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/museum-level-chinese-disassembly-infographic) | [@MrLarus](https://x.com/MrLarus/status/2045504669401653414)
...
**提示詞:**
```text
為「澄光维稳精华」製作一張高端護膚品電商主視覺海報，風格乾淨、輕奢、偏科學護膚。中央放置半透明磨砂玻璃精華瓶與金色液體，背景採用米白到暖灰漸層並搭配液體流動與分子裝飾。需要精確包含原 prompt 中列出的中文文案，如「澄光」「维稳精华」「修护屏障」「限时到手价 229 元」「买 1 送 3」等，以及細字「实际效果因人而异，请坚持使用」，並突出賣點、價格層級與贈品模組。
```
...
**提示詞:**
```text
生成一組工筆風書籤設計；設計《小王子》與 SpaceX 的聯名明信片；生成 2026 年 4 月 19 日《言叶之庭》主題單日曆；生成一組勞動節手持標語牌設計；生成 2026 年穀雨節氣海報；為運動 App 生成一套圖示字體；設計「奔赴山海」主題膠片攝影風海報；設計黑白線稿風格的上海明信片；設計一套「Elon Musk」篆刻印章；設計杜蕾斯與茶顏悅色的聯名宣傳物料。
```
...
**提示詞:**
```text
生成 [經典文本標題] 的真跡手稿圖像；或生成 [經典文本標題] 的真跡手稿圖像，並把作品的情感核心融入書法表達中。
```
...
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [Basic Thread](https://x.com/MrLarus/status/2046201836525302032) | [Emotion Variant](https://x.com/MrLarus/status/2046240175777259752)
...
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046510310253539764)
...
**提示詞:**
```text
基於 [theme: xxx] 自動生成一張高美感的「Silhouette Universe / Collector's Edition Narrative Poster」。不要預設使用瓶子、沙漏、玻璃罩、懷錶等常見容器，而是讓 AI 選出最具象徵性、視覺張力最強、最能代表主題的外輪廓。整體應像高級收藏版敘事海報，具備清晰主輪廓、完整內部世界、紙張質感、水彩肌理、低飽和高級配色與長久耐看的細節層次，避免廉價奇幻素材、硬拼貼與過度卡通化。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [Thread 1](https://x.com/MrLarus/status/2045418028733538620) | [Thread 2](https://x.com/MrLarus/status/2045748335668310055)
...
為 [商品名稱] 生成一張電商商品詳情頁。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046544209117634735)
...
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2044824800909054181)
...
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046514998965371144)
...
**提示詞:**
```text
現在洛杉磯是上午 10 點、丹佛上午 11 點、芝加哥中午 12 點、紐約下午 1 點、倫敦下午 6 點、東京凌晨 2 點。請渲染一面掛著不同類比時鐘的牆，每個時鐘都顯示對應城市的正確時間，並在下方標示城市名稱。
```
**來源:** [ @Angaisb_ ](https://x.com/Angaisb_/status/2046666389734179018)
...
**提示詞:**
```text
為 [topic] 生成一張高品質的直式百科風資訊圖。它不應是一般海報或單純插畫，而應結合圖鑑清晰度、百科頁面結構、知識卡的精緻感與社群分享性。內容需包含主視覺、放大細節標註、圓角模組資訊區塊、清晰標題層級、密集但不擁擠的教育內容、評分或 Top 5 模組，並依主題自動調整分類、外觀、機制、風險、適用對象、優缺點等欄位。整體應像可收藏的知識卡而非商業廣告。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046231542817497392)
...
**提示詞:**
```text
建立一張 10x10 網格圖，裡面的物件名稱全部以字母 A 開頭。
```
**來源:** [ @umesh_ai ](https://x.com/umesh_ai/status/2046510988367945983)
...
**提示詞:**
```text
建立一個 10 × 10 的網格，展示 100 個代表近期科技進展的不同主題。風格要真實、精緻、統一且具有編輯插畫感。每個方格都有獨立視覺與清楚標籤，涵蓋 AI 模型與智能體、機器人、半導體、網路與智慧裝置、生技與健康科技、能源、交通與自動駕駛、航太、製造與材料、氣候與環境科技等 10 行主題。
```
**來源:** [ @chetaslua ](https://x.com/chetaslua/status/2046489044243403029)
...
**提示詞:**
```text
為 [topic] 生成一張中文健身資訊圖。預設對象是健康成年人，目標是增肌與基礎力量提升，程度為初學到中階，場景為一般健身房，時長 40 到 60 分鐘。若主題是肌群，就輸出訓練計畫資訊圖；若主題是動作或技能，就輸出解鎖／進階路線資訊圖。需包含標題、副標、訓練目標、暖身、4 到 6 個核心動作、進階邏輯、替代動作、執行提醒與恢復建議，整體為清晰現代的中文直式資訊圖，而非長篇文字。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046560406760505727)
...
**提示詞:**
```text
生成一張 2026 年 [科目名稱] 高考試卷圖像。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2045529134915600868)
...
為 [城市] 生成一張三天旅遊指南圖像。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046523494003851300)
...
**提示詞:**
```text
為 [theme] 生成一張高設計感角色關係海報。它不是普通插畫，而是一張結合資訊視覺化、敘事結構、海報級設計與原作風格忠實度的關係圖。系統需自動識別原作與核心設定、挑選 6 到 12 位關鍵角色、整理血緣／愛情／友情／同盟／敵對等重要關係、選擇最合適構圖、抽取作品的風格 DNA，並透過色彩、線條與箭頭建立清晰層級，讓主要關係一眼看懂，同時具備高級海報質感。
```
**來源:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046263153546174935)

<a id="-character--consistency"></a>

## 🎭 角色與一致性
用於測試角色在多張圖像中的一致性與風格重現能力的提示詞。
...
**提示詞:**
```text
建立一張銀髮藍眼動漫少女的 16 格表情圖。她的臉型、髮型與服裝在所有格子中都要保持高度一致，16 種表情包含開心、悲傷、生氣、驚訝、害羞、無語、邪魅笑、沉思、好奇、自豪、委屈、不屑、困惑、害怕、哭泣與愛心表情。
```
*來源: [卡爾的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*
...
**提示詞:**
```text
基於這個角色與背景，建立一張類似官方設定資料的角色參考頁。需包含正面／側面／背面三視圖、不同表情變化、服裝與裝備細節拆解、配色板、簡短世界觀說明，以及白底插畫風的整齊版面。
```
**來源:** [OpenNana](https://opennana.com/awesome-prompt-gallery/official-character-reference-sheet) | [@MANISH1027512](https://x.com/MANISH1027512/status/2045013913901867334)
...
**提示詞:**
```text
主題為「77（貓的名字）X KFC」聯名海報。生成一張以同一隻寵物為主角的聯名海報，外觀與毛色必須完全一致，並融入 KFC 品牌識別（紅白配色、經典 Logo、餐廳場景等）。讓這隻貓穿上 KFC 員工制服、帽子與名牌，站在櫃檯前販售炸雞、漢堡與套餐，並與全家桶、薯條、汽水等品牌元素互動。整體要活潑有趣、具商業聯名感，適合線上宣傳與活動海報，可自由加入適當的中文文案。
```
...
**提示詞:**
```text
替這頁漫畫上色，並翻譯成中文，把文字放回原本的位置，同時維持構圖與圖像細節的一致性。
```
...
## 致謝
特別感謝中文 AI 社群提供了這批完整測試案例。Typography、Photorealism、UI/UX、Consistency 與 Image Editing 區塊新增的提示詞來自：

**卡尔的AI沃茨 (Carl's AI Watts)** - [五大真实场景横测GPT-image-2和Nano Banana2](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)

這些真實世界測試場景，對理解 GPT Image 2 在排版、真實場景生成、介面還原、角色一致性與圖像編輯任務上的能力很有幫助。

所有內容均來自網路。如果你認為其中內容侵犯了你的版權，請建立 issue，我們會及時處理。
...
## 授權
本專案採用 Creative Commons Attribution 4.0 International License。詳情請見 [LICENSE](LICENSE) 檔案。

---
*本倉庫由社群維護，與 OpenAI 無關。*
