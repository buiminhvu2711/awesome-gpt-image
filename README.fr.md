# Awesome GPT Image 2 Français

Dernière mise à jour 260424 03:26:42 UTC
...
## [Cliquez ici pour voir la version web de cette bibliothèque de prompts](https://cyberbara.com/gpt-image-prompt-library?utm_source=gpt-image-banner)
...
## Table des matières
- [📷 Photographie et photoréalisme](#-photography--photorealism)
- [🎮 Jeu et divertissement](#-game--entertainment)
- [📱 UI / UX et réseaux sociaux](#-uiux--social-media)
- [🎬 Vidéo, animation et collage](#-video-animation--collage)
- [📰 Typographie et design d'affiche](#-typography--poster-design)
- [📚 Infographies, éducation et documents](#-infographics-education--documents)
- [🎭 Personnages et cohérence](#-character--consistency)
- [🖼️ Édition d'image et transfert de style](#-image-editing--style-transfer)
...
## 📷 Photographie et photoréalisme
Prompts pour créer des scènes ultra réalistes, des caractéristiques photographiques crédibles et des éclairages complexes.


### Célébrités dans la vraie vie
<img width="500" alt="image" src="https://github.com/user-attachments/assets/45e4f24f-4f73-4426-947d-e6ed51291956" />

**Prompt:**
```text
Sam Altman, Donald Trump et Elon Musk travaillant derrière le comptoir d'un cinéma très fréquenté.
```
...
**Prompt:**
```text
Crée une photo de groupe urbaine ultra réaliste devant l'entrée d'une supérette à 22 h, une nuit d'été. Il y a 3 à 4 jeunes qui discutent brièvement, l'un tient des boissons, l'un est assis sur une chaise en plastique, un autre regarde son téléphone. Une lumière blanche intense sort des portes vitrées, avec des réverbères jaunes et des phares lointains dehors. Les personnages portent des vêtements ordinaires. Aucun style d'influenceur. Les visages et postures doivent ressembler à de vrais passants. Ajoute des éléments crédibles de supérette : autocollants de congélateur, affiches promotionnelles, poubelles, tapis d'entrée, reflets sur le verre, vélos partagés, gouttes d'eau au sol. L'image doit ressembler à une vraie tranche de vie photographiée en ville.
```
...
**Prompt:**
```text
Crée une image totalement RAW, non traitée, non retouchée, avec toute la qualité d'un appareil photo iPhone. La scène se passe dans une station de métro aux États-Unis avec un léger flou de mouvement. Le métro est en train d'arriver ou de passer. Devant lui se trouvent une femme âgée et un homme âgé.
```
**Source:** [@WolfRiccardo](https://x.com/WolfRiccardo/status/2041192232623972441)

### Photo de keynote à Apple Park depuis la foule
<img width="500" alt="Apple Park Keynote Crowd Shot" src="assets/opennana/apple-park-tim-cook-keynote.jpg" />

**Prompt:**
```text
Photo iPhone amateur à Apple Park pendant la keynote de l'iPhone 20, Tim Cook présente sur scène, vue de loin depuis la foule.
```
...
### Photo de carnet manuscrit
<img width="500" alt="Handwritten Notebook Photo" src="assets/opennana/black-pen-handwritten-notes.jpg" />

**Prompt:**
```text
Photo amateur d'un carnet ouvert posé à plat, rempli de notes manuscrites au stylo bille noir. L'écriture est naturelle, un peu brouillonne, avec imperfections, mots barrés et titres soulignés. Prise légèrement en plongée, lumière du jour venant d'une fenêtre, sans flash, sur un bureau ordinaire, photographiée à l'iPhone.
```
...
### Micro-typographie sur un grain de riz
<img width="500" alt="Rice Grain Micro Typography" src="https://pbs.twimg.com/media/HGc-2eKWYAATrs9?format=jpg&name=large" />

**Prompt:**
```text
Un énorme tas de riz, et sur un seul grain apparaît un minuscule texte qui dit "wOw".
```
...
Prompts pour reproduire des esthétiques de jeu spécifiques et générer des captures in-game crédibles.
...
**Prompt:**
```text
Un niveau Hitman où vous êtes au siège d'OpenAI et votre mission consiste à voler GPT-6 sans vous faire attraper.
```
**Source:** [@flowersslop](https://x.com/flowersslop/status/2044734896321532390)

### Scène Black Myth: Wukong
| Nano Banana 2 | GPT-Image |
|:-------------:|:---------:|
...
**Prompt:**
```text
Génère une scène de jeu Black Myth: Wukong où Wukong est projeté au loin par Erlang Shen.
```

### Capture in-game style GTA 6
| Nano Banana 2 | GPT-Image |
|:-------------:|:---------:|
...
**Prompt:**
```text
Séquence de jeu GTA 6, très détaillée et très réaliste. Gros plan pris depuis un moniteur 4K fixe, avec un léger flou comme si la photo avait été prise à la main. Environnement large et lumineux. Le personnage marche sur la plage avec / :dog.
```
**Source:** [@WolfRiccardo](https://x.com/WolfRiccardo/status/2041187268711321735)

### Mission de mariage dans GTA 6
...
**Prompt:**
```text
Aide-moi à générer une capture d'écran de Trump contre Khamenei sur la mid lane dans League of Legends.
```
**Source:** [@underwoodxie96](https://x.com/underwoodxie96/status/2046529342415790275)

### Grille de 100 objets pixel art
...
**Prompt:**
```text
Crée une image unique contenant une grille de 100 objets pixel art entièrement uniques, chacun avec une étiquette pertinente.
```
...
**Prompt:**
```text
Dans le jeu Zelda TotK, Link se trouve dans une rame série e531 qu'il a lui-même fabriquée.
```
**Source:** [@marmaduke091](https://x.com/marmaduke091/status/2040820686751432990)

### Capture GTA San Andreas
...
**Prompt:**
```text
capture de gameplay d'un lion combattant un NPC dans GTA San Andreas.
```
...
## 📱 UI / UX et réseaux sociaux
Prompts pour générer des interfaces d’app réalistes, des publications sociales et des visuels numériques soignés.



### Capture de live stream
<img width="400" alt="image" src="https://github.com/user-attachments/assets/be639d3b-617b-4332-98eb-4deb2484ac66" />

**Prompt:**
```text
Génère une capture d'écran d'un live TikTok mettant en scène une belle femme en train de streamer.
```

### Capture de live Douyin
<img width="400" alt="Douyin Livestream Screenshot" src="assets/opennana/liu-yifei-douyin-live-chat.jpg" />

**Prompt:**
```text
Au format 9:16, génère une capture d'écran de live Douyin où Liu Yifei est en direct et tient un panneau disant : "Tonight's live stream, welcome to join Yifei for a chat!"
```
...
### Capture YouTube voyage dans le temps
...
**Prompt:**
```text
Capture d'écran d'une vidéo YouTube montrant quelqu'un ayant voyagé au Moyen Âge.
```
**Source:** [@flowersslop](https://x.com/flowersslop/status/2040261168460108213)

### Fil social de la dynastie Song
<img width="400" alt="Song Dynasty Social Media Feed" src="assets/opennana/song-dynasty-cyber-social-feed.jpg" />

**Prompt:**
```text
Simule une interface de réseau social mobile, mais dont tout le contenu est transposé à la dynastie Song : portrait d'un lettré Song, nom d'utilisateur "Su Dongpo SuShi_Official", post humoristique sur son arrivée à Huangzhou, photo de porc Dongpo en style gongbi, liste de likes et commentaires, icônes et barre d'état redessinées en motifs Song, mode sombre et palette élégante inspirée de la dynastie.
```
...
### Figures historiques sur plateformes modernes
...
**Prompt:**
```text
Génère une capture de [nom de personnage historique] sur [nom de plateforme].
```
...
### Page d'accueil d'app e-commerce
| Nano Banana 2 | GPT-Image |
|:-------------:|:---------:|
...
**Prompt:**
```text
Génère une capture d'écran ultra fidèle de page d'accueil d'une app e-commerce mobile inspirée des grandes apps chinoises de 2026. Inclure barre d'état, recherche, onglets de catégories, bannière promo, grille de 10 fonctions, module flash sale, section "猜你喜欢" et barre d'onglets inférieure. Utiliser les libellés chinois exacts donnés dans le prompt d'origine, comme "杭州", "618 预售开启" ou "首页、分类、购物车、消息、我的".
```
*Source: [卡尔的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*

### Interface de lecteur musical
| Nano Banana 2 | GPT-Image |
|:-------------:|:---------:|
...
**Prompt:**
```text
Crée une interface mobile de lecteur musical chinois très réaliste en mode sombre, avec grande pochette centrale, barre de progression, commandes de lecture, paroles défilantes, actions sociales et accès au cast / à la file. Utiliser les libellés chinois exacts "正在播放", "海边的晚风", "林秋", "夏夜实验室".
```
*Source: [卡尔的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*

### Système de design UI personnalisé
<img width="500" alt="Custom Style UI Design System" src="assets/opennana/custom-style-ui-system.jpeg" />

**Prompt:**
```text
Génère pour moi un design system UI dans le style xx, incluant pages web, mobile, cartes, contrôles, boutons, etc.
```
...
### Page produit Taobao du T-800
<img width="500" alt="T-800 Taobao Product Detail Page" src="assets/opennana/terminator-taobao-page.jpeg" />

**Prompt:**
```text
Génère une page produit Taobao pour un robot T-800 montrant vues avant / profil / arrière, prix, détails produit, fonctions et cas d'usage.
```
...
## 🎬 Vidéo, animation et collage
Prompts pour créer des visuels à l’aspect vidéo, des séquences animées et des compositions en collage.
...
**Prompt:**
```text
collage d'images de tout le film Superman, en une seule sortie.
```
**Source:** [@chetaslua](https://x.com/chetaslua/status/2044462992176386532)

### Affiche “Where is [Your Name]”
...
**Prompt:**
```text
Crée une affiche de recherche dans la foule "Where is [Your Name]" située dans la ville de ton choix.
```
...
### Manga en 8 cases sur le lancement de GPT Image 2
...
**Prompt:**
```text
Crée un manga en huit cases sur le lancement de GPT-Image-2 aujourd'hui.
```
...
## 📰 Typographie et design d'affiche
Prompts pour tester la mise en page typographique complexe, la densité d’information et les designs visuels très aboutis.
...
**Prompt:**
```text
Génère une affiche de propagande des années 1980. Utilise le slogan exact "热烈庆祝GPT-Image-2全量开放". Inclure Sam Altman, Dario Amodei et Elon Musk, avec une écharpe rouge pour Dario Amodei.
```
**Source:** [@akokoi1](https://x.com/akokoi1/status/2046558658096738672)

### Affiche de lancement pour boisson au thé chinoise
...
**Prompt:**
```text
Conçois une affiche verticale 3:4 pour le lancement d'une nouvelle boisson tendance au thé chinois. Style New Chinese élégant et retenu, couleurs vert foncé / blanc cassé / or, texture papier de riz, beaucoup d'espace négatif, quelques accents paysagers et mise en page moderne. Afficher exactement les textes chinois listés dans le prompt d'origine comme "山川茶事", "山柚观音", "新品上市" et les tarifs.
```

### Infographie “Le voyage d'un café”
...
**Prompt:**
```text
Crée une infographie chinoise sur le thème "一杯咖啡 如何来到你手里" avec modules sur culture, traitement, torréfaction, mouture, extraction et arômes. Ajouter le petit texte exact "适合用于咖啡入门科普与门店展示".
```

### Carte de relations entre personnages
<img width="500" alt="Key Character Relationship Map" src="assets/opennana/key-character-relationship-map.jpeg" />

**Prompt:**
```text
Merci de générer un diagramme de relations entre les personnages clés pour "XXX".
```
...
### Diagramme de porcelaine bleu et blanc de Jingdezhen
...
**Prompt:**
```text
Génère un schéma explicatif détaillé de la porcelaine bleu et blanc de Jingdezhen, accompagné d'une analyse de connaissances détaillée en chinois.
```
...
### Infographie de démontage façon catalogue de musée
...
**Prompt:**
```text
Génère automatiquement une infographie chinoise de démontage, style catalogue de musée, à partir du [sujet]. Le résultat doit combiner visuel principal réaliste, éclaté structurel, annotations chinoises, matériaux, significations des motifs et des couleurs, et synthèse des caractéristiques, dans une esthétique de panneau muséal haut de gamme.
```
...
### Affiche premium de soin de la peau
...
**Prompt:**
```text
Crée une affiche e-commerce haut de gamme pour "澄光维稳精华" avec flacon givré semi-transparent, liquide doré, décor moléculaire et textes chinois exacts du prompt original comme "澄光", "维稳精华", "修护屏障" ou "限时到手价 229 元".
```

### Collection de prompts minimalistes
...
**Prompt:**
```text
Générer une série de marque-pages en style gongbi, une carte postale Le Petit Prince x SpaceX, un calendrier du 19 avril 2026 sur The Garden of Words, une série de pancartes du 1er mai, une affiche Grain Rain 2026, un set d'icônes pour app sportive, une affiche photo argentique "Toward the mountains and sea", une carte postale de Shanghai en line-art noir, une série de sceaux "Elon Musk" et un kit de co-branding Durex x Chayan Yuese.
```
**Source:** [@akokoi1](https://x.com/akokoi1/status/2045693939584516441)

### Reconstitution de manuscrit calligraphique chinois
| Example 1 | Example 2 | Example 3 | Example 4 |
|:---------:|:---------:|:---------:|:---------:|
...
**Prompt:**
```text
Génère l'image du manuscrit authentique de [titre du texte classique], ou une version intégrant le cœur émotionnel de l'œuvre dans la calligraphie.
```
...
### Feuille d'entraînement de calligraphie chinoise
...
**Prompt:**
```text
Génère une feuille d'entraînement de calligraphie dans le style [script style].
```
...
### Affiche narrative “Silhouette Universe”
...
**Prompt:**
```text
Génère automatiquement une affiche narrative collector à très forte valeur esthétique à partir de [thème]. L'IA doit choisir une silhouette extérieure symbolique et mémorable, construire un univers narratif riche à l'intérieur et autour, utiliser une palette raffinée et désaturée, une texture papier / aquarelle et éviter toute sensation de fantasy générique ou d'assemblage artificiel.
```
...
**Prompt:**
```text
Génère une image de [scène / contenu].
```
...
### Ordonnance manuscrite chinoise
...
**Prompt:**
```text
Génère l'image d'une ordonnance manuscrite de médecine chinoise ou occidentale.
```
...
## 📚 Infographies, éducation et documents
Prompts pour produire des fiches de connaissance, supports éducatifs, plans d’entraînement et mises en page riches en informations.


### Mur d'horloges analogiques mondiales
<img width="500" alt="World Time Analog Clock Wall" src="https://pbs.twimg.com/media/HGYD-Y4bMAA0KxJ?format=jpg&name=large" />

**Prompt:**
```text
Il est 10 h à Los Angeles, 11 h à Denver, 12 h à Chicago, 13 h à New York, 18 h à Londres et 2 h à Tokyo. Rends un mur avec différentes horloges analogiques affichant la bonne heure de chaque ville et le nom de la ville sous chaque horloge.
```
**Source:** [@Angaisb_](https://x.com/Angaisb_/status/2046666389734179018)

### Carte de connaissances style encyclopédie
...
**Prompt:**
```text
Génère une infographie verticale de haute qualité pour [sujet], avec visuel principal, détails agrandis, sections modulaires arrondies, hiérarchie de titres, contenu pédagogique dense, et un rendu proche d'une carte de connaissance premium plutôt que d'une publicité.
```
**Source:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046231542817497392)

### Grille d'objets en A
<img width="500" alt="Alphabet Object Grid" src="https://pbs.twimg.com/media/HGaqAFba0AES6z_?format=jpg&name=large" />

**Prompt:**
```text
Crée une image avec une grille 10x10 d'objets dont les noms commencent tous par la lettre A.
```
...
**Prompt:**
```text
Crée une grille 10 × 10 présentant 100 sujets illustrant les progrès technologiques récents, de l'IA à la robotique, en passant par les semi-conducteurs, la biotech, l'énergie, le spatial et les technologies climatiques.
```
**Source:** [@chetaslua](https://x.com/chetaslua/status/2046489044243403029)

### Infographie d'entraînement fitness
...
**Prompt:**
```text
Génère une infographie fitness en chinois pour [sujet], adaptée à un adulte en bonne santé, avec objectif prise de muscle et progression de force. Inclure objectif, échauffement, 4 à 6 exercices principaux, logique de progression, variantes, conseils d'exécution et récupération, sous forme d'infographie claire et moderne.
```
**Source:** [Article](https://x.com/MrLarus/status/2046627021674168640) | [@MrLarus](https://x.com/MrLarus/status/2046560406760505727)

### Réplique de feuille d'examen Gaokao
...
**Prompt:**
```text
Génère une affiche de relations entre personnages très design pour [thème], capable d'identifier l'œuvre source, sélectionner les personnages clés, structurer liens familiaux / romantiques / politiques / conflictuels, extraire l'ADN visuel de l'œuvre et produire une carte lisible, élégante et partageable.
```
...
Prompts qui testent la cohérence d’un personnage sur plusieurs images et la reproduction de style.


### Grille d'expressions anime en 16 cases
| Nano Banana 2 | GPT-Image |
|:-------------:|:---------:|
...
**Prompt:**
```text
Crée une grille de 16 expressions d'une fille d'anime aux cheveux argentés et aux yeux bleus, avec une cohérence très forte du visage, de la coiffure et des vêtements dans toutes les cases.
```
*Source: [卡尔的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*

### Feuille de référence officielle de personnage
<img width="500" alt="Official Character Reference Sheet" src="assets/opennana/official-character-reference-sheet.jpeg" />

**Prompt:**
```text
À partir de ce personnage et de cet arrière-plan, crée une fiche de référence façon matériel de setting officiel, avec vues face / profil / dos, variations d'expressions, détails de vêtements et d'équipement, palette de couleurs et courte explication du monde.
```
...
## 🖼️ Édition d'image et transfert de style
Prompts pour l’édition d’image, le transfert de style et la génération guidée par référence.

*Source: [卡尔的AI沃茨](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)*

### Affiche de collaboration de marque avec animal
...
**Prompt:**
```text
Thème "77 (cat's name) X KFC". Génère une affiche de collaboration montrant exactement le même animal avec l'identité de marque KFC, son uniforme, son comptoir, du poulet frit, des burgers, des frites, des sodas et d'autres éléments de marque. Le ton doit être ludique et commercial, avec possibilité d'ajouter librement du texte chinois sur l'affiche.
```

### Colorisation et traduction d'une page de BD
...
**Prompt:**
```text
Colorise cette page de bande dessinée et traduis-la en chinois, en remettant le texte à sa place d'origine tout en conservant la composition et les détails de l'image.
```
...
## Remerciements
Un grand merci à la communauté IA chinoise pour ces cas de test très complets. Les nouveaux prompts ajoutés aux sections Typography, Photorealism, UI/UX, Consistency et Image Editing proviennent de :

**卡尔的AI沃茨 (Carl's AI Watts)** - [五大真实场景横测GPT-image-2和Nano Banana2](https://mp.weixin.qq.com/s/ASxig6mFVYxrIE8-8Fthew)

Ces scénarios de test issus du monde réel apportent des informations précieuses sur les capacités de GPT Image 2 en typographie, génération de scènes réalistes, recréation d’interfaces, cohérence de personnage et édition d’image.

Tout le contenu provient d’Internet. Si vous estimez qu’un élément enfreint vos droits d’auteur, ouvrez une issue et nous le retirerons.
...
## Licence
Ce projet est publié sous licence Creative Commons Attribution 4.0 International. Voir le fichier [LICENSE](LICENSE) pour les détails.

---
*Ce dépôt est maintenu par la communauté et n’est pas affilié à OpenAI.*
